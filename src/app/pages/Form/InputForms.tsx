import imgLogo from "../../../assets/LogoFLIK.png";

function Logo() {
  return (
    <div
      className="content-stretch flex flex-col items-start relative shrink-0 w-[200px]"
      data-name="Logo"
    >
      <div
        className="h-[32px] relative shrink-0 w-[89px]"
...
function Nav() {
  return (
    <div
      ...
      data-name="Nav"
    >
      <p className="css-ew64yg font-w400 leading-[1.5] not-italic relative shrink-0 text-[#111928] text-[18px]">
        Merchant Kami
      </p>
    </div>
  );
...
function Button() {
  return (
    <div
      className="bg-[#701bc1] content-stretch flex h-[64px] items-center justify-center px-[20px] py-[16px] relative rounded-[10px] shrink-0 w-[200px]"
      data-name="Button"
    >
      <p className="css-ew64yg font-w400 leading-[1.5] not-italic relative shrink-0 text-[16px] text-white tracking-[-0.16px]">
...
function Title() {
  return (
    ...
    >
      ...
      <p className="css-4hzbpn font-w400 leading-[1.5] relative shrink-0 text-[20px] w-[430px]">
...
function Field() {
  return (
    <div
      className="bg-white h-[48px] relative rounded-[6px] shrink-0 w-full"
      data-name="Field"
    >
      <div
        aria-hidden="true"
        className="absolute border border-[#d1d5db] border-solid inset-[-1px] pointer-events-none rounded-[7px]"
      />
...
function InputFieldStandardDefault() {
  return (
    <div
      className="content-stretch flex flex-col gap-[8px] h-[98px] items-start relative shrink-0 w-full"
    ...
    >
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center px-[12px] py-[16px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-w400 justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#6b7280] text-[16px]">
            <p className="css-4hzbpn leading-[1.5]">
              Website bisnis atau akun Instagram bisnis kamu
            </p>
          </div>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="css-g0mm18 flex flex-col font-w400 justify-end leading-[0] not-italic relative shrink-0 text-[#6b7280] text-[14px]">
        <p className="css-ew64yg leading-[1.5]">
    ...
    >
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center px-[12px] py-[16px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-w400 justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#6b7280] text-[16px]">
            <p className="css-4hzbpn leading-[1.5]">
              Masukin nomor telepon (whatsapp)
            </p>
          </div>
        </div>
      </div>
    ...
    >
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center px-[12px] py-[16px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-w400 justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#6b7280] text-[16px]">
            <p className="css-4hzbpn leading-[1.5]">
              Masukin nama dan nama usaha nya ya (jika ada).
            </p>
          </div>
        </div>
      </div>
...
function Field5() {
  return (
    <div
      className="bg-white h-[200px] relative rounded-[6px] shrink-0 w-full"
      data-name="Field"
    >
      <div
        aria-hidden="true"
      ...
      <div className="content-stretch flex gap-[16px] items-start px-[12px] py-[16px] relative size-full">
        <div className="flex flex-[1_0_0] flex-col font-w400 justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#6b7280] text-[16px]">
          <p className="css-4hzbpn leading-[1.5]">
            Jelasin secara singkat apa yang bisa FLIK bantu untuk kamu.
          </p>
        </div>
      </div>
    </div>
...
function Button1() {
  return (
    <div
      ...
      data-name="Button"
    >
      <p className="css-ew64yg font-w500 leading-[1.5] not-italic relative shrink-0 text-[16px] text-white">
        Kirim ke FLIK →
      </p>
    </div>
  );
...
function Links() {
  return (
    <div
      className="capitalize content-stretch flex flex-[1_0_0] font-w400 gap-[16px] items-center justify-end leading-[0] min-h-px min-w-px not-italic relative text-[#111928] text-[16px] tracking-[-0.096px]"
      data-name="Links"
    >
      ...
      <div className="css-g0mm18 flex flex-col justify-end relative shrink-0">
        <p className="css-ew64yg decoration-solid leading-[24px] underline">
          kebijakan privasi
        </p>
      </div>
      <div className="css-g0mm18 flex flex-col justify-end relative shrink-0">
